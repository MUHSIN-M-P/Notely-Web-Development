    ...
    return (
        <div
            className={`side-panel ${
                props.isSidebarVisible ? "active" : "hidden"
            }`}
        >
            <div className="logo">
                <img src={logo} alt="" />
            ...
            <div className={`options ${dropDown ? "slide" : ""}`}>
                ...
                >
                    <div
                        className={`item ${
                            location === "/home/create-note" ? "selected" : ""
                        }`}
                    >
                        <img
                            src="https://img.icons8.com/?size=20&id=3220&format=png&color=8f8a89"
                            alt=""
                        />
                        <p>New Note</p>
                    </div>
