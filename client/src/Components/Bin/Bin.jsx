...
export const Bin = () => {
    ...
    useEffect(() => {
        const checkNotes = async () => {
            try {
                const response = await axios.get(`${API_URL}/home/bin`, {
    ...
    const handleDelete = async (noteId) => {
        try {
            const response = await fetch(`${API_URL}/home/bin/${noteId}`, {
                method: "DELETE",
                credentials: "include",
            });
            if (response.ok) {
                setBinNotes((prevNotes) =>
