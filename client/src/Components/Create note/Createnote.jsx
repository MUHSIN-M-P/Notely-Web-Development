...
export const Createnote = () => {
        ...
        try {
            const response = await axios.post(
                `${API_URL}/home/create-note`,
                {
                    ...
                    color,
                    reminder: reminder ? moment(reminder).toISOString() : null, // Convert to ISO string for database
                },
    ...
    const handleDateChange = (date) => {
        if (moment(date).isValid()) {
            setTempReminder(date); // Store the moment object
        }
    };
    ...
    return (
        <div className="create-note">
            <div className="heading">Create Note</div>
